    ...
    <div className="relative min-h-screen bg-cream-light/30">
      ...
      <div className="min-h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative py-8 sm:py-12">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center justify-center min-h-[calc(100vh-4rem)]">
          {/* Image Section */}
          <div className="relative w-full h-[300px] xs:h-[350px] sm:h-[400px] lg:h-[75vh] order-2 lg:order-1 group">
            ...
            >
              <div className="relative">
                <h1 className="relative text-center sm:text-left">
                  <span className="block text-5xl sm:text-6xl md:text-7xl xl:text-8xl font-serif mb-2 
                    bg-gradient-to-r from-secondary-dark to-primary bg-clip-text text-transparent
                    animate-gradient">
                    İBRAHİM
                  </span>
                  <span className="block text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-serif mt-2
              ...
              <h2 className="text-xl sm:text-2xl md:text-3xl text-secondary-dark/90 font-light tracking-wide text-center sm:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
                <a
                  href="/portfolyo"
                  className="w-full sm:w-auto relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 overflow-hidden 
